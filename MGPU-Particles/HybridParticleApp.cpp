...
//     }
    ...
    //auto grassEmitter = std::make_shared<GrassEmitter>(primeDevice, 5000, 200.0f); // 50k травинок
    ...
    crossGrassEmitters.push_back(grassEmitter.get()); // если нужен список для управления
    gameObjects.push_back(std::move(grassField));
