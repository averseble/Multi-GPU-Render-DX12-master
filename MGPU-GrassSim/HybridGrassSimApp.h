...
class HybridGrassSimApp :
    public Common::D3DApp
{
public:
    HybridGrassSimApp(HINSTANCE hInstance);
    ~HybridGrassSimApp() override;
...
protected:
   ...
   // PassConstants shadowPassCB;
    ...
    friend void HybridGrassSimApp_ImGuiSrvAllocFn(ImGui_ImplDX12_InitInfo* info,
                                                  D3D12_CPU_DESCRIPTOR_HANDLE* out_cpu_handle,
                                                  D3D12_GPU_DESCRIPTOR_HANDLE* out_gpu_handle);
    friend void HybridGrassSimApp_ImGuiSrvFreeFn(ImGui_ImplDX12_InitInfo* info,
